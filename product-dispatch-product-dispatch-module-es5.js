(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["product-dispatch-product-dispatch-module"], {
    ...
    /***/
    function BvKb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function AddNicknameComponent_mat_chip_9_mat_icon_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddNicknameComponent_mat_chip_9_Template(rf, ctx) {
        if (rf & 1) {
          var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-chip", 15);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("removed", function AddNicknameComponent_mat_chip_9_Template_mat_chip_removed_0_listener() {
            ...
            return ctx_r4.removeSerial(i_r2);
          });
          ...
          value: function onYesClick() {
            ...
            if (this.form.valid) {
              if (this.selectedCharger.length > 0) {
                ...
                var params = {
                  data: this.selectedCharger.map(function (v) {
                    return {
                      id: v.id,
                ...
                this.snackBar.open("No charger is selected to add nickname", 'Dismiss', {
                  duration: 5000
                });
              }
            }
      ...
      AddNicknameComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function AddNicknameComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddNicknameComponent_Template_button_click_18_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddNicknameComponent_Template_button_click_20_listener() {
              return ctx.close();
            });
    ...
    /***/
    function IkzP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JZaj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(CreateComponent, [{
          ...
          value: function getSerialNo() {
            ...
            this.chargerService.getPlantChargers().subscribe(function (data) {
              if (data != null) {
                _this2.chargerSerials = data;
                _this2.chargerSerialsOrg = _toConsumableArray(_this2.chargerSerials);
                _this2.filteredOptionSerial = _this2.form.controls.serialNumber.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (value) {
                  ...
                  return serial_no ? _this2._filterSerial(serial_no) : _this2.chargerSerials;
                }));
              }
            }, function (err) {});
          }
          ...
          value: function getClients() {
            ...
            this.clientService.getActiveClientsCW(this.localStorage.userId).subscribe(function (data) {
              if (data != null) {
                _this3.clients = data;
                _this3.filteredOptionsClient = _this3.form.controls.client.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (value) {
                  return typeof value === 'string' ? value : value.name;
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (name) {
                  return name ? _this3._filterClientModels(name) : _this3.clients;
                }));
              }
            }, function (err) {});
          }
          ...
          value: function onSerialSelected(event) {
            ...
            this.filteredOptionSerial = this.form.controls.serialNumber.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (value) {
              ...
              return serial_no ? _this4._filterSerial(serial_no) : _this4.chargerSerials;
            }));
          }
        }, {
          key: "onSubmit",
            ...
            if (this.form.valid) {
              ...
              if (this.selectedSerialNo.length == 0) {
                ...
                this.chargerService.getProductDispatch(params).subscribe(function (data) {
                  if (data.status = true) {
                    _this5.returnDataStatus = true;
                    _this5.selectedSerialNo = [];

                    _this5.getClients();

                    _this5.response_mapped = data.data[0].chargers_mapped;
                    _this5.response_unmapped = data.data[0].chargers_not_mapped;
                    formDirective.resetForm();

                    _this5.form.reset();

                    _this5.form.markAsPristine();
                  }

                  if (_this5.response_mapped.length < 0) {} else {
                    _this5.cdr.detectChanges();

                    _this5.mappedDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](_this5.response_mapped);
                    _this5.mappedDataSource.paginator = _this5.mappedPaginator;
                  }

                  if (_this5.response_unmapped.length < 0) {} else {
                    _this5.cdr.detectChanges();

                    _this5.unmappedDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](_this5.response_unmapped);
                    _this5.unmappedDataSource.paginator = _this5.unmappedPaginator;
                  }

                  _this5.snackBar.open(app_shared_utils_message_constant__WEBPACK_IMPORTED_MODULE_3__["MessageConstant"].salesDispatch, 'Dismiss', {
                    duration: 5000
                  });
                }, function (err) {
          ...
          value: function uploadedFile(evt) {
            ...
            reader.onload = function (e) {
              ...
              var data = _this6.excelSrv.importFromFile(bstr);

              var header = Object.getOwnPropertyNames(new SerialData());
              var importedData = data.slice(1);
              _this6.importSerialNo = importedData.map(function (arr) {
                var obj = {};
              ...
              for (var i = 0; i < _this6.importSerialNo.length; i++) {
                for (var j = 0; j < _this6.chargerSerials.length; j++) {
                  if (_this6.importSerialNo[i].serial_no == _this6.chargerSerials[j].serial_no) {
                    _this6.selectedSerialNo.push(_this6.chargerSerials[j]);
                  }
                }
              } // this.selectedSerialNo.push(this.importSerialNo);


              _this6.uploadExcelTable = true;

              _this6.cdr.detectChanges();

              _this6.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](_this6.selectedSerialNo);
              _this6.dataSource.paginator = _this6.importPaginator;
            };
          ...
          value: function removeSerial(i) {
            ...
            this.filteredOptionSerial = this.form.controls.serialNumber.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (value) {
              ...
              return serial_no ? _this7._filterSerial(serial_no) : _this7.chargerSerials;
            }));
          }
        }, {
          key: "selectionMade",
    ...
    function TOE(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ProductDispatchModule", function () {
        return ProductDispatchModule;
      });
      /* harmony import */
      ...
      var _product_dispatch_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./product-dispatch-routing.module */
      "sZqr");
      /* harmony import */
      ...
      var _product_dispatch_crud_product_dispatch_crud_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./product-dispatch-crud/product-dispatch-crud.component */
      "YAPP");
      /* harmony import */
      ...
      var _add_list_add_list_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./add-list/add-list.component */
      "AOCH");
      /* harmony import */
      ...
      var ProductDispatchModule = function ProductDispatchModule() {
        _classCallCheck(this, ProductDispatchModule);
      };

      ProductDispatchModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: ProductDispatchModule
      });
      ProductDispatchModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function ProductDispatchModule_Factory(t) {
          return new (t || ProductDispatchModule)();
        },
        imports: [[app_shared_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"], _product_dispatch_routing_module__WEBPACK_IMPORTED_MODULE_4__["ProductDispatchRoutingModule"], _angular_material_components_datetime_picker__WEBPACK_IMPORTED_MODULE_11__["NgxMatDatetimePickerModule"], _fuse_shared_module__WEBPACK_IMPORTED_MODULE_7__["FuseSharedModule"], _angular_material_components_datetime_picker__WEBPACK_IMPORTED_MODULE_11__["NgxMatNativeDateModule"], _angular_material_components_datetime_picker__WEBPACK_IMPORTED_MODULE_11__["NgxMatTimepickerModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ProductDispatchModule, {
          declarations: [_product_dispatch_crud_product_dispatch_crud_component__WEBPACK_IMPORTED_MODULE_6__["ProductDispatchCrudComponent"], _create_create_component__WEBPACK_IMPORTED_MODULE_2__["CreateComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_3__["ListComponent"], _add_list_add_list_component__WEBPACK_IMPORTED_MODULE_10__["AddListComponent"], _action_dialog_action_dialog_component__WEBPACK_IMPORTED_MODULE_5__["ActionDialogComponent"], _view_dialog_view_dialog_component__WEBPACK_IMPORTED_MODULE_8__["ViewDialogComponent"], _add_nickname_add_nickname_component__WEBPACK_IMPORTED_MODULE_9__["AddNicknameComponent"]],
          imports: [app_shared_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"], _product_dispatch_routing_module__WEBPACK_IMPORTED_MODULE_4__["ProductDispatchRoutingModule"], _angular_material_components_datetime_picker__WEBPACK_IMPORTED_MODULE_11__["NgxMatDatetimePickerModule"], _fuse_shared_module__WEBPACK_IMPORTED_MODULE_7__["FuseSharedModule"], _angular_material_components_datetime_picker__WEBPACK_IMPORTED_MODULE_11__["NgxMatNativeDateModule"], _angular_material_components_datetime_picker__WEBPACK_IMPORTED_MODULE_11__["NgxMatTimepickerModule"]]
        });
      })();
      /*@__PURE__*/
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductDispatchModule, [{
    ...
    /***/
    function YAPP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ProductDispatchCrudComponent", function () {
        return ProductDispatchCrudComponent;
      });
      /* harmony export (binding) */
      ...
      function ProductDispatchCrudComponent_a_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var ProductDispatchCrudComponent = /*#__PURE__*/function () {
        function ProductDispatchCrudComponent(router, cdr, _utilityService) {
          _classCallCheck(this, ProductDispatchCrudComponent);

          this.router = router;
          this.cdr = cdr;
          this._utilityService = _utilityService;
          this.tabLinks = [// { label: 'Sales Dispatch', link: 'list' },
            // { label: 'Add New', link: 'create' }
          ];
          this.tempLinks = [];
        }

        _createClass(ProductDispatchCrudComponent, [{
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {
            var _this8 = this;

            this._utilityService.activeMenuItems$.subscribe(function (menuItemSelecte) {
              _this8.menuArray = menuItemSelecte;

              if (_this8.menuArray == null || _this8.menuArray == undefined || _this8.menuArray.title == null || _this8.menuArray.title == undefined) {
                _this8.menuArray = JSON.parse(localStorage.getItem('activeMenuItems'));
              }
          ...
          value: function ngOnInit() {
            ...
            nav_list.filter(function (x) {
              if (x.id === "chargerManagement") {
                ...
                if (_this9.objectData.children != undefined) {
                  _this9.objectData.children.filter(function (y) {
                    if (y.id === "crud") {
                      _this9.objectChildData = y;

                      if (_this9.objectChildData.children != undefined) {
                        _this9.objectChildData.children.filter(function (z) {
                          ...
                          if (!isDefaultRoutePermeted) {
                            _this9.router.navigate(['/assetManagement/chargerManagement/salesDispatch/crud/' + _this9.tempLinks[0].link]);
                          }
                        });
                      }
                    }
      ...
      ProductDispatchCrudComponent.ɵfac = function ProductDispatchCrudComponent_Factory(t) {
        return new (t || ProductDispatchCrudComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_shared_services_utility_utility_service__WEBPACK_IMPORTED_MODULE_3__["UtilityService"]));
      };

      ProductDispatchCrudComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: ProductDispatchCrudComponent,
        selectors: [["app-product-dispatch-crud"]],
        decls: 10,
        vars: 6,
        ...
        template: function ProductDispatchCrudComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJwcm9kdWN0LWRpc3BhdGNoLWNydWQuY29tcG9uZW50LnNjc3MifQ== */"],
        encapsulation: 2,
        data: {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductDispatchCrudComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
    ...
    /***/
    function pzpv(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function ListComponent_mat_card_8_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function ListComponent_mat_card_8_Template_mat_autocomplete_optionSelected_8_listener($event) {
            ...
            return ctx_r29.onClientChange($event.option.value.client_id);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function ListComponent_mat_card_8_Template_mat_autocomplete_optionSelected_19_listener($event) {
            ...
            return ctx_r31.onCPOChange($event.option.value.cpo_id);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function ListComponent_mat_card_8_Template_mat_autocomplete_optionSelected_30_listener($event) {
            ...
            return ctx_r32.onStationChange($event.option.value.station_id);
          });
        ...
        if (rf & 2) {
          ...
          var _r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](20);

          var _r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](31);
      ...
      function ListComponent_th_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ListComponent_th_14_Template_mat_checkbox_change_1_listener($event) {
      ...
      function ListComponent_td_15_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_td_15_Template_mat_checkbox_click_1_listener($event) {
            return $event.stopPropagation();
          })("change", function ListComponent_td_15_Template_mat_checkbox_change_1_listener($event) {
      ...
      function ListComponent_th_17_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_17_span_1_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r41.changeVisibility("clientSearch", $event);
          });
      ...
      function ListComponent_th_17_mat_form_field_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_th_17_mat_form_field_2_Template_input_ngModelChange_1_listener($event) {
            ...
            return ctx_r43.filterEntity.client_name = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_17_mat_form_field_2_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r45.changeVisibility("clientSearch", $event);
          });
      ...
      function ListComponent_th_20_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_20_span_1_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r49.changeVisibility("nameSearch", $event);
          });
      ...
      function ListComponent_th_20_mat_form_field_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_th_20_mat_form_field_2_Template_input_ngModelChange_1_listener($event) {
            ...
            return ctx_r51.filterEntity.name = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_20_mat_form_field_2_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r53.changeVisibility("nameSearch", $event);
          });
      ...
      function ListComponent_th_23_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_23_span_1_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r57.changeVisibility("serialSearch", $event);
          });
      ...
      function ListComponent_th_23_mat_form_field_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_th_23_mat_form_field_2_Template_input_ngModelChange_1_listener($event) {
            ...
            return ctx_r59.filterEntity.serial_no = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_23_mat_form_field_2_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r61.changeVisibility("serialSearch", $event);
          });
      ...
      function ListComponent_th_26_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_26_span_1_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r65.changeVisibility("modelSearch", $event);
          });
      ...
      function ListComponent_th_26_mat_form_field_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_th_26_mat_form_field_2_Template_input_ngModelChange_1_listener($event) {
            ...
            return ctx_r67.filterEntity.model_name = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_26_mat_form_field_2_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r69.changeVisibility("modelSearch", $event);
          });
      ...
      function ListComponent_th_29_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_29_span_1_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r73.changeVisibility("statusSearch", $event);
          });
      ...
      function ListComponent_th_29_mat_form_field_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_th_29_mat_form_field_2_Template_input_ngModelChange_1_listener($event) {
            ...
            return ctx_r75.filterEntity.statusString = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_29_mat_form_field_2_Template_mat_icon_click_2_listener($event) {
            ...
            return ctx_r77.changeVisibility("statusSearch", $event);
          });
      ...
      function ListComponent_td_33_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_td_33_Template_mat_icon_click_1_listener() {
            ...
            return ctx_r80.viewDialog("VIEW", element_r79);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_td_33_Template_mat_icon_click_4_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r81);
            ...
            return ctx_r82.openDialog("EDIT", element_r79);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_td_33_Template_mat_icon_click_7_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r81);
            ...
            return ctx_r83["delete"](element_r79.id);
          });
      ...
      var ListComponent = /*#__PURE__*/function () {
        function ListComponent(chargerService, dialog, snackBar, fb, chargingStationService) {
        ...
        _createClass(ListComponent, [{
          ...
          value: function getAllClientChargers(id) {
            ...
            this.chargerService.getAllClientChargers(id).subscribe(function (data) {
              if (data != null) {
                _this10.allChargers = data;

                for (var i = 0; i < _this10.allChargers.length; i++) {
                  if (_this10.allChargers[i].status == 'N') {
                    _this10.allChargers[i].statusString = 'Inactive';
                  } else {
                    _this10.allChargers[i].statusString = 'Active';
                  }
                }

                _this10.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this10.allChargers);
          ...
          value: function _delete(id) {
            ...
            this.confirmDialogRef.afterClosed().subscribe(function (result) {
              if (result) {
                _this11.chargerService.deleteChargerFromClient(id, _this11.localStorage.userId).subscribe(function (data) {
                  _this11.getAllClientChargers(_this11.localStorage.userId);
          ...
          value: function openDialog(action, data) {
            ...
            dialogRef.afterClosed().subscribe(function (result) {
              ...
              _this12.getAllClientChargers(_this12.localStorage.userId);
            });
          }
        }, {
          ...
          value: function getClients() {
            ...
            if (this.localStorage.role_code != 'END') {
              ...
              this.filteredOptionsCharClient = this.form.controls.charClient.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["map"])(function (value) {
                ...
                return name ? _this15._filterCharClient(name) : _this15.clientList;
              }));
            }
          }
        }, {
          ...
          value: function getCPOByClient(client_id) {
            ...
            if (this.localStorage.role_code != "END") {
              ...
              this.filteredOptionsCharCPO = this.form.controls.charCPO.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["map"])(function (value) {
                ...
                return name ? _this16._filterCharCPO(name) : _this16.cpoList;
              }));
            }
          }
        }, {
          ...
          value: function getStationByCPO(id) {
            ...
            if (this.localStorage.role_code != "END") {
              ...
              this.filteredOptionsCharStat = this.form.controls.charStat.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["map"])(function (value) {
                ...
                return station_name ? _this17._filterCharStat(station_name) : _this17.station;
              }));
            }
          }
        }, {
    ...
    /***/
    function sZqr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ProductDispatchRoutingModule", function () {
        return ProductDispatchRoutingModule;
      });
      /* harmony import */
      ...
      var _product_dispatch_crud_product_dispatch_crud_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./product-dispatch-crud/product-dispatch-crud.component */
      "YAPP");
      /* harmony import */


      var _product_dispatch_crud_routes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./product-dispatch-crud/routes */
      "IkzP");
      /* harmony import */
      ...
      var routes = [{
        path: 'crud',
        component: _product_dispatch_crud_product_dispatch_crud_component__WEBPACK_IMPORTED_MODULE_2__["ProductDispatchCrudComponent"],
        canActivate: [app_shared_interceptors_auth_gaurd__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
        children: _product_dispatch_crud_routes__WEBPACK_IMPORTED_MODULE_3__["TABS_DEMO_ROUTES"]
      }];

      var ProductDispatchRoutingModule = function ProductDispatchRoutingModule() {
        _classCallCheck(this, ProductDispatchRoutingModule);
      };

      ProductDispatchRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: ProductDispatchRoutingModule
      });
      ProductDispatchRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function ProductDispatchRoutingModule_Factory(t) {
          return new (t || ProductDispatchRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ProductDispatchRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductDispatchRoutingModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
...
//# sourceMappingURL=product-dispatch-product-dispatch-module-es5.js.map