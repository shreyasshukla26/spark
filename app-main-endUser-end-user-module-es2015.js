...
const routes = [
    {
        path: 'end-user',
        loadChildren: () => __webpack_require__.e(/*! import() | end-user-map-end-user-map-module */ "end-user-map-end-user-map-module").then(__webpack_require__.bind(null, /*! ./end-user-map/end-user-map.module */ "XEfX")).then(m => m.EndUserMapModule),
        data: { title: 'User' }
    },
];
...
/* harmony import */ var _end_user_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./end-user-routing.module */ "j4tg");
...
EndUserModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function EndUserModule_Factory(t) { return new (t || EndUserModule)(); }, imports: [[app_shared_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"], _end_user_routing_module__WEBPACK_IMPORTED_MODULE_2__["EndUserRoutingModule"], _fuse_shared_module__WEBPACK_IMPORTED_MODULE_5__["FuseSharedModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_3__["MatRadioModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_4__["MatCheckboxModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](EndUserModule, { imports: [app_shared_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"], _end_user_routing_module__WEBPACK_IMPORTED_MODULE_2__["EndUserRoutingModule"], _fuse_shared_module__WEBPACK_IMPORTED_MODULE_5__["FuseSharedModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_3__["MatRadioModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_4__["MatCheckboxModule"]] }); })();
...
//# sourceMappingURL=app-main-endUser-end-user-module-es2015.js.map