(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["manage-user-station-manage-user-station-module"], {
    ...
    /***/
    function H2J(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ManageUserStationModule", function () {
        return ManageUserStationModule;
      });
      /* harmony import */
      ...
      var _manage_user_station_crud_manage_user_station_crud_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./manage-user-station-crud/manage-user-station-crud.component */
      "SzmY");
      /* harmony import */
      ...
      var _manage_user_station_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./manage-user-station-routing.module */
      "A4tb");
      /* harmony import */
      ...
      var COMPONENTS = [_manage_user_station_crud_manage_user_station_crud_component__WEBPACK_IMPORTED_MODULE_2__["ManageUserStationCrudComponent"], _create_create_component__WEBPACK_IMPORTED_MODULE_3__["CreateComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_4__["ListComponent"]];
      ...
      var ManageUserStationModule = function ManageUserStationModule() {
        _classCallCheck(this, ManageUserStationModule);
      };

      ManageUserStationModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: ManageUserStationModule
      });
      ManageUserStationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function ManageUserStationModule_Factory(t) {
          return new (t || ManageUserStationModule)();
        },
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ManageUserStationModule, [{
    ...
    function wcl(module, __webpack_exports__, __webpack_require__) {
      ...
      var app_shared_services_user_user_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      function ActionDialogComponent_mat_option_43_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 32);
      ...
      function ActionDialogComponent_mat_error_50_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function ActionDialogComponent_mat_option_55_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 32);
      ...
      function ActionDialogComponent_mat_radio_button_61_Template(rf, ctx) {
        if (rf & 1) {
          var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-radio-button", 33);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ActionDialogComponent_mat_radio_button_61_Template_mat_radio_button_change_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19);

            var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r18.radioChange($event);
          });
        ...
        if (rf & 2) {
          var radioButton_r17 = ctx.$implicit;
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", radioButton_r17.station_name, "\xA0\xA0 ");
        }
      }
      ...
      var ActionDialogComponent = /*#__PURE__*/function () {
        function ActionDialogComponent(fb, datePipe, router, cpoService, snackBar, clientService, userService, dialogRef, data, cdr) {
        ...
        _createClass(ActionDialogComponent, [{
          ...
          value: function onYesClick() {
            ...
            var formValues = this.form.value; //this.pins.push(formValues.pins);

            var params = {
              user_id: formValues.userList.id,
              station_data: this.radiobuttonList.map(function (v) {
                return {
                  ...
                  default_station: v.default_station
                };
              }),
            ...
            if (this.isEditMode) {
              this.userService.UserStationMappingV1(params).subscribe(function (resp) {
                if (resp.status == true) {
                  _this.snackBar.open('User Station Update successfully!', 'Dismiss', {
                    duration: 5000
                  });

                  _this.router.navigate(['/userManagement/manageUserStation/crud']);
                } else {
                  if (resp.err_code == "ERROR : ER_DUP_ENTRY") {
                    _this.errorMsg = resp.message;

                    _this.snackBar.open(app_shared_utils_message_constant__WEBPACK_IMPORTED_MODULE_6__["MessageConstant"].nameDuplicateCity, 'Dismiss', {
                      duration: 5000
                    });
                  } else {
          ...
          key: "onCPOChange",
          value: function onCPOChange(cpo) {
            ...
            this.clientService.getActiveClientsCW(this.localStorage.userId).subscribe(function (data) {
              ...
              if (_this2.isEditMode) {
                var toSelect = _this2.clients.find(function (c) {
                  return c.id == _this2.params.data.client_id;
                });

                _this2.form.get('client').setValue(toSelect);
              }

              _this2.filteredOptionsClient = _this2.form.controls.client.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (value) {
          ...
          key: "getCPOS",
          value: function getCPOS(client_id) {
            var _this3 = this;

            this.cpoService.getCpoByClientId(client_id).subscribe(function (data) {
              _this3.cposName = data;

              if (_this3.isEditMode) {
                var toSelect = _this3.cposName.find(function (c) {
                  return c.id == _this3.params.data.cpo_id;
                });

                _this3.form.get('cpos').setValue(toSelect);
              }

              _this3.filteredOptionsCpo = _this3.form.controls.cpos.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (value) {
                return typeof value === 'string' ? value : value.name;
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (name) {
                return name ? _this3._filterCharCPO(name) : _this3.cposName;
              }));
            }, function (err) {});
          }
        }, {
          ...
          value: function getUserList(id) {
            ...
            this.userService.getActiveUsersByClient(id).subscribe(function (resp) {
              _this4.users = resp.data;

              if (_this4.isEditMode) {
                var toSelect = _this4.users.find(function (c) {
                  return c.id == _this4.params.data.user_id;
                });

                _this4.form.get('userList').setValue(toSelect);
              }

              _this4.filteredOptionsUser = _this4.form.controls.userList.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (value) {
                return typeof value === 'string' ? value : value.username;
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (username) {
                return username ? _this4._filterUserModels(username) : _this4.users;
              }));
            }, function (err) {});
          }
        }, {
          ...
          value: function onUserChange(user) {
            ...
            this.userService.getStationListWithStationAssignedToUser(this.form.controls.client.value.id, user.id).subscribe(function (resp) {
              if (resp.status != 'false') {
                _this5.stations = resp.data;
                var selectedList = [];

                for (var i = 0; i < _this5.stations.length; i++) {
                  if (_this5.stations[i].default_station == 'Y') {
                    _this5.form.get('defaultStation').setValue(_this5.stations[i]);
                  }

                  var userStation = _this5.stations[i];
                ...
                _this5.form.get('stationList').setValue(selectedList);

                _this5.radiobuttonList = selectedList;
              }
            }, function (err) {});
          }
        }, {
          ...
          key: "getDefaultStation",
          value: function getDefaultStation() {
            var _this6 = this;

            this.userService.getStationListWithStationAssignedToUser(this.params.data.client_id, this.params.data.user_id).subscribe(function (resp) {
              if (resp.status != 'false') {
                _this6.stations = resp.data;
                var selectedList = [];

                for (var i = 0; i < _this6.stations.length; i++) {
                  var userStation = _this6.stations[i];

                  if (_this6.stations[i].default_station == 'Y') {
                    _this6.form.get('defaultStation').setValue(_this6.stations[i]);
                  }
                ...
                _this6.form.get('stationList').setValue(selectedList);

                _this6.radiobuttonList = selectedList;

                for (var k = 0; k < _this6.radiobuttonList; k++) {
                  if (_this6.radiobuttonList[k].default_station == 'Y') {
                    _this6.form.get('defaultStation').setValue(_this6.radiobuttonList[k]);
                  }
                }
              }
            }, function (err) {});
      ...
      ActionDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ActionDialogComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function ActionDialogComponent_Template_input_optionSelected_25_listener($event) {
              return ctx.onCPOChange($event.option.value);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function ActionDialogComponent_Template_mat_autocomplete_optionSelected_41_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function ActionDialogComponent_Template_mat_select_selectionChange_54_listener($event) {
              return ctx.onStationChange($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ActionDialogComponent_Template_mat_slide_toggle_change_63_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ActionDialogComponent_Template_button_click_67_listener() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ActionDialogComponent, [{
          ...
          return [{
            ...
            type: app_shared_services_user_user_service__WEBPACK_IMPORTED_MODULE_11__["UserService"]
          }, {
    ...
    /***/
    function A4tb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ManageUserStationRoutingModule", function () {
        return ManageUserStationRoutingModule;
      });
      /* harmony import */
      ...
      var _manage_user_station_crud_routes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./manage-user-station-crud/routes */
      "MRsN");
      /* harmony import */
      ...
      var routes = [{
        path: 'crud',
        component: _manage_user_station_crud_manage_user_station_crud_component__WEBPACK_IMPORTED_MODULE_2__["ManageUserStationCrudComponent"],
        canActivate: [app_shared_interceptors_auth_gaurd__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
        children: _manage_user_station_crud_routes__WEBPACK_IMPORTED_MODULE_3__["TABS_DEMO_ROUTES"]
      }];

      var ManageUserStationRoutingModule = function ManageUserStationRoutingModule() {
        _classCallCheck(this, ManageUserStationRoutingModule);
      };

      ManageUserStationRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: ManageUserStationRoutingModule
      });
      ManageUserStationRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function ManageUserStationRoutingModule_Factory(t) {
          return new (t || ManageUserStationRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ManageUserStationRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ManageUserStationRoutingModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
    ...
    /***/
    function Djg8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ManageUserStation", function () {
        return ManageUserStation;
      });
      /* harmony export (binding) */
      ...
      function ListComponent_th_13_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_13_span_1_Template_mat_icon_click_2_listener() {
            ...
            return ctx_r14.changeVisibility("stationSearch");
          });
      ...
      function ListComponent_th_13_mat_form_field_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_th_13_mat_form_field_2_Template_input_ngModelChange_1_listener($event) {
            ...
            return ctx_r16.filterEntity.station_name = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_13_mat_form_field_2_Template_mat_icon_click_2_listener() {
            ...
            return ctx_r18.changeVisibility("stationSearch");
          });
      ...
      function ListComponent_th_16_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_16_span_1_Template_mat_icon_click_2_listener() {
            ...
            return ctx_r22.changeVisibility("nameSearch");
          });
      ...
      function ListComponent_th_16_mat_form_field_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_th_16_mat_form_field_2_Template_input_ngModelChange_1_listener($event) {
            ...
            return ctx_r24.filterEntity.f_name = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_16_mat_form_field_2_Template_mat_icon_click_2_listener() {
            ...
            return ctx_r26.changeVisibility("nameSearch");
          });
      ...
      function ListComponent_th_19_span_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Default Station \xA0\xA0 ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_19_span_1_Template_mat_icon_click_2_listener() {
            ...
            return ctx_r30.changeVisibility("defStationSearch");
          });
      ...
      function ListComponent_th_19_mat_form_field_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ListComponent_th_19_mat_form_field_2_Template_input_ngModelChange_1_listener($event) {
            ...
            return ctx_r32.filterEntity.default_station = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_th_19_mat_form_field_2_Template_mat_icon_click_2_listener() {
            ...
            return ctx_r34.changeVisibility("defStationSearch");
          });
      ...
      function ListComponent_td_26_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_td_26_Template_mat_icon_click_7_listener() {
            ...
            return ctx_r48["delete"](element_r44.map_id);
          });
      ...
      var ManageUserStation = function ManageUserStation() {
        _classCallCheck(this, ManageUserStation);
      };
      /**
      ...
      var ListComponent = /*#__PURE__*/function () {
        function ListComponent(stateService, dialog, userService, snackBar) {
        ...
        _createClass(ListComponent, [{
          ...
          value: function getAllUserStationMapping() {
            var _this7 = this;

            this.userService.getAllUserStationMapping(this.localStorage.userId).subscribe(function (resp) {
              if (resp.data != null) {
                _this7.userStanList = resp.data;

                for (var i = 0; i < _this7.userStanList.length; i++) {
                  if (_this7.userStanList[i].status == 'N') {
                    _this7.userStanList[i].statusString = 'Inactive';
                  } else {
                    _this7.userStanList[i].statusString = 'Active';
                  }
                }

                _this7.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this7.userStanList);
          ...
          value: function _delete(id) {
            ...
            this.confirmDialogRef.afterClosed().subscribe(function (result) {
              if (result) {
                _this8.userService.deleteUserStationMapping(id, _this8.localStorage.userId).subscribe(function (data) {
                  if (data.status == true) {
                    _this8.getAllUserStationMapping();
          ...
          value: function openDialog(action, data) {
            ...
            dialogRef.afterClosed().subscribe(function (result) {
              ...
              _this9.getAllUserStationMapping();
            });
          }
        }, {
          key: "viewDialog",
          value: function viewDialog(action, data) {
            ...
            dialogRef.afterClosed().subscribe(function (result) {
              // this.moderate(result);
              _this10.getAllUserStationMapping();
            });
          }
        }, {
          ...
          value: function tableExport() {
            ...
            for (var i = 0; i < this.dataSource.filteredData.length; i++) {
              ...
              var data = {
                'Station name': userstation.station_name,
                'Name': userstation.f_name,
                'Default Station': userstation.default_station,
                'Status ': userstation.statusString
              };
          ...
          value: function pdfExport() {
            ...
            for (var i = 0; i < this.dataSource.filteredData.length; i++) {
              var userstation = this.dataSource.filteredData[i]; //this.exportedData.push({name: `name${i}`, description: `description${i}`,
            ...
            doc.autoTable({
              ...
              didDrawPage: function didDrawPage(data) {
                ...
                doc.text('Manage User Station Report', doc.internal.pageSize.getWidth() / 2, 11, {
                  align: 'center'
                });
    ...
    /***/
    function MRsN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function SzmY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ManageUserStationCrudComponent", function () {
        return ManageUserStationCrudComponent;
      });
      /* harmony export (binding) */
      ...
      function ManageUserStationCrudComponent_a_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var ManageUserStationCrudComponent = /*#__PURE__*/function () {
        function ManageUserStationCrudComponent(router) {
          _classCallCheck(this, ManageUserStationCrudComponent);

          this.router = router; // Nav bar demo

          this.tabLinks = [// { label: 'Station-User List', link: 'list' },
            // { label: 'Add New', link: 'create' }
          ];
          this.tempLinks = [];
        }

        _createClass(ManageUserStationCrudComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this12 = this;
                ...
                if (_this12.objectData.children != null && _this12.objectData.children != undefined) {
                  _this12.objectData.children.filter(function (y) {
                    if (y.id === "manageUserStation") {
                      ...
                      if (_this12.objectChildData.children != undefined && _this12.objectChildData.children != null) {
                        _this12.objectChildData.children.filter(function (z) {
                          ...
                          if (!isDefaultRoutePermeted) {
                            _this12.router.navigate(['/userManagement/manageUserStation/crud/' + _this12.tempLinks[0].link]);
                          }
                        });
                      }
                    }
      ...
      ManageUserStationCrudComponent.ɵfac = function ManageUserStationCrudComponent_Factory(t) {
        return new (t || ManageUserStationCrudComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
      };

      ManageUserStationCrudComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: ManageUserStationCrudComponent,
        selectors: [["app-manage-user-station-crud"]],
        decls: 10,
        vars: 6,
        ...
        template: function ManageUserStationCrudComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJtYW5hZ2UtdXNlci1zdGF0aW9uLWNydWQuY29tcG9uZW50LnNjc3MifQ== */"],
        encapsulation: 2,
        data: {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ManageUserStationCrudComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
    ...
    /***/
    function Tx5w(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function ViewDialogComponent_mat_option_54_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 31);
      ...
      function ViewDialogComponent_mat_radio_button_60_Template(rf, ctx) {
        if (rf & 1) {
          var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-radio-button", 32);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ViewDialogComponent_mat_radio_button_60_Template_mat_radio_button_change_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19);
      ...
      var ViewDialogComponent = /*#__PURE__*/function () {
        function ViewDialogComponent(fb, datePipe, clientService, userService, dialogRef, data, cpoService) {
        ...
        _createClass(ViewDialogComponent, [{
          ...
          value: function getClients() {
            ...
            this.clientService.getActiveClientsCW(this.localStorage.userId).subscribe(function (data) {
              ...
              if (_this13.isEditMode) {
                var toSelect = _this13.clients.find(function (c) {
                  return c.id == _this13.params.data.client_id;
                });

                _this13.form.get('client').setValue(toSelect);
              }

              _this13.filteredOptionsClient = _this13.form.controls.client.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (value) {
                return typeof value === 'string' ? value : value.name;
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (name) {
                return name ? _this13._filterClientModels(name) : _this13.clients;
              }));
            }, function (err) {});
          }
        }, {
          ...
          value: function getCPOS(client_id) {
            ...
            this.cpoService.getCpoByClientId(client_id).subscribe(function (data) {
              ...
              if (_this14.isEditMode) {
                ...
                _this14.form.get('cpos').setValue(toSelect);
              }

              _this14.filteredOptionsCpo = _this14.form.controls.cpos.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (value) {
                return typeof value === 'string' ? value : value.name;
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (name) {
                return name ? _this14._filterCharCPO(name) : _this14.cposName;
              }));
            }, function (err) {});
          }
        }, {
          ...
          value: function getUserList(id) {
            ...
            this.userService.getActiveUsersByClient(id).subscribe(function (resp) {
              ...
              if (_this15.isEditMode) {
                var toSelect = _this15.users.find(function (c) {
                  return c.id == _this15.params.data.user_id;
                });

                _this15.form.get('userList').setValue(toSelect);
              }

              _this15.filteredOptionsUser = _this15.form.controls.userList.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (value) {
                return typeof value === 'string' ? value : value.username;
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (username) {
          ...
          value: function onUserChange(user) {
            ...
            this.userService.getStationListWithStationAssignedToUser(this.form.controls.client.value.id, user.id).subscribe(function (resp) {
              if (resp.status != 'false') {
                _this16.stations = resp.data;
                var selectedList = [];

                for (var i = 0; i < _this16.stations.length; i++) {
                  if (_this16.stations[i].default_station == 'Y') {
                    _this16.form.get('defaultStation').setValue(_this16.stations[i]);
                  }

                  var userStation = _this16.stations[i];
                ...
                _this16.form.get('stationList').setValue(selectedList);
          ...
          value: function getDefaultStation() {
            ...
            this.userService.getStationListWithStationAssignedToUser(this.params.data.client_id, this.params.data.user_id).subscribe(function (resp) {
              if (resp.status != 'false') {
                _this17.stations = resp.data;
                var selectedList = [];

                for (var i = 0; i < _this17.stations.length; i++) {
                  var userStation = _this17.stations[i];

                  if (_this17.stations[i].default_station == 'Y') {
                    _this17.form.get('defaultStation').setValue(_this17.stations[i]);
                  }
                ...
                _this17.form.get('stationList').setValue(selectedList);

                _this17.radiobuttonList = selectedList;

                for (var k = 0; k < _this17.radiobuttonList; k++) {
                  if (_this17.radiobuttonList[k].default_station == 'Y') {
                    _this17.form.get('defaultStation').setValue(_this17.radiobuttonList[k]);
                  }
                }
              }
            }, function (err) {});
      ...
      ViewDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ViewDialogComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function ViewDialogComponent_Template_mat_autocomplete_optionSelected_40_listener($event) {
              return ctx.onUserChange($event.option.value);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function ViewDialogComponent_Template_mat_select_selectionChange_53_listener($event) {
              return ctx.onStationChange($event);
            });
    ...
    /***/
    function X4Qz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function CreateComponent_mat_radio_button_59_Template(rf, ctx) {
        if (rf & 1) {
          var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-radio-button", 29);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CreateComponent_mat_radio_button_59_Template_mat_radio_button_change_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19);
      ...
      var CreateComponent = /*#__PURE__*/function () {
        function CreateComponent(fb, snackBar, router, cpoService, clientService, userService, roleService, cdr) {
        ...
        _createClass(CreateComponent, [{
          ...
          value: function onSubmit() {
            ...
            if (this.form.valid) {
              ...
              this.userService.UserStationMappingV1(params).subscribe(function (resp) {
                if (resp.status == true) {
                  _this18.snackBar.open(app_shared_utils_message_constant__WEBPACK_IMPORTED_MODULE_2__["MessageConstant"].userStationAssign, 'Dismiss', {
                    duration: 5000
                  });

                  _this18.router.navigate(['userManagement/manageUserStation/crud']);
                } else {
                  _this18.snackBar.open(app_shared_utils_message_constant__WEBPACK_IMPORTED_MODULE_2__["MessageConstant"].errorMessage, 'Dismiss', {
                    duration: 5000
                  });
                }
              }, function (err) {
          ...
          value: function getClients() {
            ...
            this.clientService.getActiveClientsCW(this.localStorage.userId).subscribe(function (data) {
              _this19.clients = data;

              var toSelect = _this19.clients.find(function (c) {
                return c.id == _this19.localStorage.client_id;
              });

              _this19.form.get('client').setValue(toSelect);

              _this19.getCPOS(toSelect.id);

              _this19.getUserList(toSelect.id);

              _this19.filteredOptionsClient = _this19.form.controls.client.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (value) {
                return typeof value === 'string' ? value : value.name;
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (name) {
                return name ? _this19._filterClientModels(name) : _this19.clients;
              }));
            }, function (err) {});
          }
        }, {
          ...
          value: function getCPOS(client_id) {
            ...
            this.cpoService.getCpoByClientId(client_id).subscribe(function (data) {
              _this20.cposName = data;
              _this20.filteredOptionsCpo = _this20.form.controls.cpos.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (value) {
                return typeof value === 'string' ? value : value.name;
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (name) {
          ...
          value: function getUserList(id) {
            ...
            this.userService.getActiveUsersByClient(id).subscribe(function (resp) {
              _this21.users = resp.data;
              _this21.filteredOptionsUser = _this21.form.controls.userList.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (value) {
                return typeof value === 'string' ? value : value.username;
              }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (username) {
                return username ? _this21._filterUserModels(username) : _this21.users;
              }));
            }, function (err) {});
          }
        }, {
          ...
          value: function onUserChange(user) {
            ...
            this.userService.getStationListWithStationAssignedToUser(this.form.controls.client.value.id, user.id).subscribe(function (resp) {
              if (resp.status != 'false') {
                _this22.stations = resp.data;
                var selectedList = [];

                for (var i = 0; i < _this22.stations.length; i++) {
                  if (_this22.stations[i].default_station == 'Y') {
                    _this22.form.get('defaultStation').setValue(_this22.stations[i]);
                  }

                  var userStation = _this22.stations[i];
                ...
                _this22.form.get('stationList').setValue(selectedList);

                _this22.radiobuttonList = selectedList;
              }
            }, function (err) {});
          }
        }]);
      ...
      CreateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function CreateComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionSelected", function CreateComponent_Template_mat_autocomplete_optionSelected_36_listener($event) {
              return ctx.onUserChange($event.option.value);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function CreateComponent_Template_mat_select_selectionChange_49_listener($event) {
              return ctx.onStationChange($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CreateComponent_Template_mat_slide_toggle_change_61_listener($event) {
              return ctx.updateStatus($event);
            });
...
//# sourceMappingURL=manage-user-station-manage-user-station-module-es5.js.map