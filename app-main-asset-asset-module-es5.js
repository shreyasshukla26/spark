(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-main-asset-asset-module"], {
    ...
    /***/
    function J87w(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      /*! @angular/router */
      "tyNb"); // import { ChargerCrudComponent } from './charger-crud/charger-crud.component';
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | charger-type-charger-type-module */
          [__webpack_require__.e("common"), __webpack_require__.e("charger-type-charger-type-module")]).then(__webpack_require__.bind(null,
          /*! ./charger-type/charger-type.module */
          "9dZ2")).then(function (m) {
            return m.ChargerTypeModule;
          });
        },
        data: {
          title: 'Charger Type',
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | alarm-configuration-alarm-configuration-module */
          [__webpack_require__.e("common"), __webpack_require__.e("alarm-configuration-alarm-configuration-module")]).then(__webpack_require__.bind(null,
          /*! ./alarm-configuration/alarm-configuration.module */
          "Pq8p")).then(function (m) {
            return m.AlarmConfigurationModule;
          });
        },
        data: {
          title: 'Charger Type',
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | charger-model-charging-model-module */
          [__webpack_require__.e("common"), __webpack_require__.e("charger-model-charging-model-module")]).then(__webpack_require__.bind(null,
          /*! ./charger-model/charging-model.module */
          "Ozft")).then(function (m) {
            return m.ChargingModelModule;
          });
        },
        data: {
          title: 'Charging Model',
          titleI18n: 'chargingModel'
        }
      }, {
        path: 'chargerManagement',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | charger-charger-management-module */
          "charger-charger-management-module").then(__webpack_require__.bind(null,
          /*! ./charger/charger-management.module */
          "THMh")).then(function (m) {
            return m.ChargerManagementModule;
          });
        },
        data: {
          title: 'Charger',
        ...
        loadChildren: function loadChildren() {
          ...
          "vehicle-vehicle-module").then(__webpack_require__.bind(null,
          /*! ./vehicle/vehicle.module */
          "i/W4")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | rfid-management-rfid-management-module */
          "rfid-management-rfid-management-module").then(__webpack_require__.bind(null,
          /*! ./rfid-management/rfid-management.module */
          "DZ/b")).then(function (m) {
            return m.RfidManagementModule;
          });
        },
        // loadChildren: () => import('./configuration/vehicle/vehicle.module').then(m => m.VehicleModule),
        data: {
          title: 'RFID Management',
          titleI18n: 'rfidManagement'
        }
      }];
    ...
    /***/
    function NdFN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=app-main-asset-asset-module-es5.js.map